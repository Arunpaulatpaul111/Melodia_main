              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form method="post" action="../../StudentAction.php">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="sName" id="sName" class="form-control" onchange="validateName()" required/>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="sContact" id="sContact" class="form-control" onchange="Validatep()" required/>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="date" id="sDob" name="sDob" class="form-control" onchange="Validatedate()" required/>
                          <label style="display:nne; color:red" id="date_error"></label>
                          <script>
                            function Validatedate() {
                              var a=new Date();
                              var b=document.getElementById('sDob').value;
                              var c=new Date(b);
                              if((a.getFullYear() - c.getFullYear() >10)){
                                return true;
                              } else{
                                $("#date_error").html('Must be 10 year or above..!').fadeIn().delay(4000).fadeOut();
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="sGender" id="sGender" class="form-control" onblur="ValidateGender()" required>
                          ...
                          <script>
                            function ValidateGender() {
                              var val = document.getElementById('sGender').value;
                              if (val=="") {
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" id="sFather" name="sFather" class="form-control" onchange="Validatefname()" required/>
                          <label style="display:nne; color:red" id="fname_error"></label>
                          <script>
                            function Validatefname() {
                              var val = document.getElementById('sFather').value;
                              if (!val.match(/^[A-Za-z][A-Za-z" "]{3,}$/)) {
                                $("#fname_error").html('Invalid Name..!').fadeIn().delay(4000).fadeOut();
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" id="sMother" name="sMother" class="form-control" onchange="Validatemname()"; required/>
                          <label style="display:nne; color:red" id="mname_error"></label>
                          <script>
                            function Validatemname() {
                              var val = document.getElementById('sMother').value;
                              if (!val.match(/^[A-Za-z][A-Za-z" "]{3,}$/)) {
                                $("#mname_error").html('Invalid Name..!').fadeIn().delay(4000).fadeOut();
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" id="pContact" name="pContact" class="form-control" onchange="Validatepc()" required/>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="sAddress" id="sAddress" class="form-control" onchange="Validateaddress()" required/>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="sDistrict" id="sDistrict" class="form-control" onchange="Validatedistrict()" required/>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="sCity" id="sCity" class="form-control" onchange="Validatecity()" required/>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="sPin" id="sPin" class="form-control" onchange="Validatepin()" required/>
                    ...
                    <button type="submit" name="sProfile" id="sProfile" class="btn btn-primary pull-right">Save</button>
