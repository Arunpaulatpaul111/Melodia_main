<?php
  ...
  if(isset($_SESSION['login_id'])){
    ...
    $sId=$_SESSION['sId'];
    // $sql="select s_id from tbl_studentdetails where dStatus=0 and login_id=".$_SESSION['login_id'];
    // $res=mysqli_query($con,$sql)or die(mysqli_error($con));
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                    ...
                    <?php
                        $sql1="select * from tbl_regcourse where dStatus=0 and s_id=".$sId;
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($row1=mysqli_fetch_array($res1)){
                                            ...
                                            echo"<tr>"
                                                ."<td>$c</td>";
                                            $sql2="select instruName from tbl_instruments where dStatus=0 and instru_id=".$row1['instru_id'];
                                            $res2=mysqli_query($con,$sql2)or die(mysqli_error($con));
                                            while($row2=mysqli_fetch_array($res2)){
                                                $iName=$row2['instruName'];
                                            }
                                            echo"<td>".$iName."</td>";
                                            $sql3="select batchName from tbl_schedule where dStatus=0 and batch_id=".$row1['batch_id'];
                                            $res3=mysqli_query($con,$sql3)or die(mysqli_error($con));
                                            while($row3=mysqli_fetch_array($res3)){
                                                $bName=$row3['batchName'];
                                            }
                                            echo"<td>".$bName."</td>";
                                            if($row1['regStatus']==0){
                                                $rStatus="Applied";
