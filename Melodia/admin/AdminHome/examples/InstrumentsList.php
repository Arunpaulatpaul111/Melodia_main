                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <?php
                              $sql1="SELECT * FROM tbl_instruments JOIN tbl_facincharge ON tbl_instruments.instru_id=tbl_facincharge.instru_id WHERE tbl_instruments.dStatus=0";
