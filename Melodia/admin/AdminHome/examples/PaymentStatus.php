      ...
      <div class="content">
        <div>
          <form method="post" action="../../AdminAction.php">
            <button type="submit" name="feeGen" id="feeGen" class="btn btn-primary pull-right">Upload Fee</button>
          </form>
        </div>
        <div class="container-fluid">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Click button to generate payment</p>
                </div>
                <div class="card-body">
