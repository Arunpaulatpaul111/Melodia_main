                            ...
                            <!-- <div class="col-md-8"> -->
                                <div class="card">
                                    <div class="card-header card-header-primary">
                                        ...
                                        <p class="card-category">Cancel here itself....</p>
                                    </div>
                                    <div class="card-body">
                                        <form method="post" action="../../FacultyAction.php">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input id="ldate" name="ldate" class="form-control" type="date" onchange="Validatedate()" required/>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="lreason" name="lreason" onchange="Validatereason()" required/>
                                            ...
                                            <button type="submit" class="btn btn-primary pull-right" name="fLeave" id="fLeave">Apply</button>
                                        </form>
                                    </div>
                                </div>
                            <!-- </div> -->
