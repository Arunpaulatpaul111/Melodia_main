                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
                                                $no=0;
                                                $sql1="select * from tbl_facleave where fac_id=".$_SESSION['facId'];
                                                ...
                                                if($rowC1 !=0){
                                                    while($row1=mysqli_fetch_array($res1)){
                                                        ...
                                                        echo"<tr>"
                                                            ...
                                                            ."<td>".$row1['flDate']."</td>"
                                                            ."<td>".$row1['flReason']."</td>"
                                                            ."<td id='status$no'>".$status."</td>";
                                                        if($row1['flStatus']==0){
                                                            // echo"<td><button class='button' type='submit' name='cancelfleave' id='cancelfleave' value='".$row1['fl_id']."'>cancel</button></td>";
                                                            echo"<td id='action$no' name='action$no'><button name='$no' id='$no' value=".$row1['fl_id']." onclick='doCancel(this.value,this.id);' style='border:none;background-color:white;' class='material-icons'>cancel</button></td>";
                                                    ...
                                                    echo"<tr><td align='center' colspan='5'><b style='color:red;'>No data found.........!</b></td></tr>";
                                                }
                                            ?>
                                            <script>
