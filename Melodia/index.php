        ...
        <nav>
            <div class="container">
                <div class="nav-top clearfix">
                    <div class="logo">
                    <h2>MELODIA</h2><p>-----Musical Institute</p>
                        <!-- <a  href="" class="navbar-brand"><img src="assets/images/logo.png" alt="Logo" /></a> -->
                    </div>

                    <div class="head_top_social pull-right">
                        <ul class="list-inline">
                            <li><a href=""><i class="fa fa-skype"></i>Melodia</a></li>
                            <li><a href=""><i class="fa fa-phone"></i>+91 8592095528</a></li>
                            <li class="top_socail">
                            ...
                            <div class="main_home_content">
                                <div class="single_home">
                                    <div class="main_home wow fadeInUp" data-wow-duration="700ms">
                                        ...
                                        <h1 class="subtitle">LEARNING IN 6 MONTHS</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="copyright_text text-center">
                            <p class=" wow fadeInRight" data-wow-duration="1s">Made by getarun 2019. All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
